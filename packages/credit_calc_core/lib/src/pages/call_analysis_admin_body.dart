...
import '../ai/call_analysis_admin_service.dart';
import '../ai/call_analysis_config_service.dart';

/// Editor prompt Analisi telefonata (BackOffice app e web).
class CallAnalysisAdminBody extends StatefulWidget {
  const CallAnalysisAdminBody({
    super.key,
    required this.verifyAdmin,
  });

  final CallAnalysisAdminVerifier verifyAdmin;

  @override
  State<CallAnalysisAdminBody> createState() => _CallAnalysisAdminBodyState();
}

class _CallAnalysisAdminBodyState extends State<CallAnalysisAdminBody> {
  ...
  Future<void> _save() async {
    ...
    try {
      await CallAnalysisAdminService.savePrompt(
        prompt,
          ...
          child: Column(
            ...
            children: [
              Text(
                ...
                'Sviluppa → Analisi telefonata. Guida la valutazione della '
                'pratica e il suggerimento delle leve prima del contatto col debitore.',
