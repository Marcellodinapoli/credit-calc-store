...
class _CommissionCollectionsPageState extends State<CommissionCollectionsPage> {
  /// `null` = Vedi tutto (tutti i mesi con incassi).
  late CommissionMonthKey? _selectedMonth =
      CommissionCollectionsHelper.defaultFilterMonth();
  ...
  void _resetFilters() {
    setState(() {
      _selectedMonth = CommissionCollectionsHelper.defaultFilterMonth();
          ...
          children: [
            Row(
              children: [
                ...
                TextButton.icon(
                  onPressed: monthOptions.isEmpty
                      ? null
                      : _resetFilters,
