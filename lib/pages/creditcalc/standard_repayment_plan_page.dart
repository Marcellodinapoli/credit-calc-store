...
class _MultiPracticePlanResult {
  ...
  static _MultiPracticePlanResult? buildMonthlyParallel({
    ...
    while (true) {
      ...
      if (active.isEmpty) break;
      if (monthOffset > 2400) return null;
...
class _StandardRepaymentPlanPageState extends State<StandardRepaymentPlanPage> {
  ...
  bool get _canDevelopPlan {
    ...
    if (_isPracticeGrossEmpty(0)) return false;
    if (_parseBirthYear() == null) return false;
    ...
    if (_planSizingMode == _PlanSizingMode.manual) {
      return _validateManualSizing(showEmptyAsInvalid: true).isValid;
    }
    return _netDebt() > 0;
  }
  ...
  Widget _tabOrder(int order, Widget child) {
        ...
        child: FocusTraversalGroup(
          ...
          child: Column(
            ...
            children: [
              ...
              if (_cadenza == 'Mensile') _skipFocus(_monthlyPlanCountSelector()),
              ...
              if (_usesMultiPracticeForm) ...[
                _tabOrder(
                  ...
                  _debtAmountField(
                    ...
                    _rataMensileCondivisaCtrl,
                    errorText: _sharedMonthlyRateError(),
                  ),
                ),
                _skipFocus(
                  Padding(
              ...
              Padding(
                ...
                child: SizedBox(
                  ...
                  child: OutlinedButton.icon(
                    onPressed: _exportingCommissions
                        ? null
          ...
          actions: [
            ...
            AdaptiveActionBarAction(
              ...
              child: FilledButton.icon(
                ...
                label: Text(
                  _calcolato ? 'Piano sviluppato' : 'Sviluppa piano',
                ),
              ),
            ),
          ],
  ...
  List<Widget> _paymentMethodFields(int tabIndex) {
    ...
    if (methods.isNotEmpty &&
      ...
      WidgetsBinding.instance.addPostFrameCallback((_) {
        if (!mounted) return;
        setState(_syncPaymentMethodForCreditor);
      });
    }
  ...
  Widget _accontoField() {
    return Padding(
      ...
      child: appAdaptiveEuroTextField(
        ...
        textInputAction: TextInputAction.next,
        onEditingComplete: () => _advanceFocus(context),
  ...
  Widget _manualDesiredAmountField({String? errorText}) {
    return Padding(
      ...
      child: Focus(
        ...
        child: appAdaptiveEuroTextField(
          fieldKey: const ValueKey('manual_desired_installment'),
          controller: _desiredInstallmentCtrl,
          textInputAction: TextInputAction.next,
          onChanged: (_) => _onManualFieldChanged(),
          onEditingComplete: _commitManualValidation,
          decoration: appFormFieldDecoration(
  ...
  Widget _modulatedAmountField(
    ...
    final field = appAdaptiveEuroTextField(
      controller: controller,
      textInputAction: TextInputAction.next,
      onChanged: (_) => _onModulatedFieldChanged(),
      onEditingComplete: () =>
