...
import '../../core/admin/normative_search_admin_service.dart';
import '../../services/normative_search_config_service.dart';
import '../area/personal_area_shell.dart';

/// Backoffice — prompt di sistema per Ricerca normativa semplificata.
class BkNormativeSearchPage extends StatefulWidget {
  const BkNormativeSearchPage({super.key});

  @override
  State<BkNormativeSearchPage> createState() => _BkNormativeSearchPageState();
}

class _BkNormativeSearchPageState extends State<BkNormativeSearchPage> {
      ...
      body: _checkingAdmin
          ...
          : !_isAdmin
              ...
              : StreamBuilder<String>(
                  stream: NormativeSearchConfigService.watchPrompt(),
                  builder: (context, snapshot) {
                    ...
                    return SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            'Configura il prompt di sistema usato dall\'assistente '
                            'nella pagina Strumenti «Ricerca normativa semplificata».',
                            style: TextStyle(
