/**
 * Pubblica settings/registration_consents su Firestore (una tantum).
 * Uso: node scripts/seed_registration_consents.mjs
 */
...
const version = '2025';
const text = `PRIVACY POLICY E CONSENSI
...
Ultimo aggiornamento: ${version}`;

admin.initializeApp({ projectId: 'creditform-d505d' });
const db = admin.firestore();
const ref = db.collection('settings').doc('registration_consents');
...
console.log(`OK: settings/registration_consents (v${version}) pubblicato.`);
